...
public class BankServiceImpl implements BankService {
	...
	@Override
	@Transactional (isolation=Isolation.SERIALIZABLE,propagation=Propagation.REQUIRED,timeout=300,rollbackFor=IllegalAccessException.class,transactionManager="dsTxMgmr")
